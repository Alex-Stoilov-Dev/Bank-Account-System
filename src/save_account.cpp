...
void save_account(Account *acc)
{
  ...
  if (!std::filesystem::exists("/home/alex/Programing/Cpp_Projects/Bank-Account-App/src/user_data/"))
  {
    std::filesystem::create_directories("/home/alex/Programing/Cpp_Projects/Bank-Account-App/src/user_data/");
  }
  else
  {
